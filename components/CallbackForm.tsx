...
export function CallbackForm({ locale = "es" }: CallbackFormProps) {
  ...
  const t = isEnglish
    ? {
        ...
        messagePlaceholder: "Tell us about your project: location, date, deliverables, etc.",
    ...
    : {
        ...
        messagePlaceholder: "Cuéntanos ubicación, fecha, entregables, etc.",
  ...
  return (
    <div className="callback-wrap">
      ...
      <form
        ...
        aria-label={t.legend}
      >
        <input type="hidden" name="_subject" value="Babula Shots — nuevo callback (drone)" />
        <input type="hidden" name="_next" value="https://dron.babulashotsrd.com/?sent=ok" />
        ...
        <fieldset>
          ...
          <input type="hidden" name="niche" value="drone" />
